...
def compliments_results():
    ...
    print(request.args.get('wants_compliments'))
...
def image_filter():
    ...
    if request.method == 'POST':
        ...
        chosen_filter_type = request.form['filter_type']
        ...
        save_image(image, chosen_filter_type)

        # Call `apply_filter()` on the file path & filter type

        image_url = f'./static/images/{image.filename}'
        apply_filter(image_url, chosen_filter_type)
...
def gif_search():
    ...
    if request.method == 'POST':
        ...
        # variable
        gif_search = request.form['search_query']
        gif_quantity = request.form['quantity']
